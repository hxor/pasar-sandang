                    ...
                    <div class="newsletter">
                        <form>
                            <div>
                                ...
                                <input type="text" placeholder="Enter your email address" class="input-text" title="Sign up for our newsletter" id="newsletter1"
                                    name="email">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="contacts-info">
                        <address><i class="add-icon"></i>ABC Town Luton Street,<br> New York 226688</address>
    ...
    <div class="footer-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="payment-accept"> <img src="{{ asset('assets/front/images/payment-1.png') }}" alt=""> <img src="{{ asset('assets/front/images/payment-2.png') }}"
                            alt=""> <img src="{{ asset('assets/front/images/payment-3.png') }}" alt=""> <img src="{{ asset('assets/front/images/payment-4.png') }}"
                            alt=""> </div>
                </div>
            </div>
        </div>
