    ...
    <div class="row p-t-20">
        <div class="col-md-12">
            ...
            <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                ...
                @if ($sponsor->path)
                    <img src="{{ asset($sponsor->path) }}" id="holder" style="margin-top:15px;max-height:254px;max-width: 152px;">
                @endif
                <img id="holder" style="margin-top:15px;max-height:254px;max-width: 152px;">
            </div>
            <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                {!! Form::label('type', 'Status') !!}
                {!! Form::select('type', $type, null, ['id' => 'type', 'class' => $errors->has('type') ? 'form-control form-control-danger' : 'form-control']) !!}
